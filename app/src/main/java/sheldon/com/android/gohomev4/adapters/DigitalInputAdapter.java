...
public class DigitalInputAdapter extends RecyclerView.Adapter<DigitalInputAdapter.WidgetViewHolder> {
    ...
    public DigitalInputAdapter(ArrayList<WidgetMonitor> widgets) {
